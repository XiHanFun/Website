...
export const products: Product[] = [
  ...
  },
  {
    ...
    status: 'v2.0.0',
    stable: true,
    desc: '框架无关的设计系统运行时：17 个包已发布 npm，内核与状态机不绑定任何框架，Vue、React 与 Web Components 各自作为适配器接入同一套无头内核。定位引擎、状态机、代码高亮、WebGL 背景、程序化音效全部自研，底层包不引第三方运行时依赖。',
    features: ['17 包', '134 组件', '框架无关', '三适配器', '无第三方运行时'],
    demo: null,
...
export const stats: Stat[] = [
  ...
  { label: '前端组件', value: 134, suffix: '个', note: 'XiHan.UI' },
